...
export function CoinAnimation({ isSpinning, lastBet, choice }: CoinAnimationProps) {
  ...
  return (
    <div className="flex flex-col items-center gap-3">
      <div
        className={clsx(
          'relative flex h-36 w-36 items-center justify-center rounded-full motion-safe:transition-shadow motion-reduce:transition-none',
          outcome === 'win' && 'shadow-lg shadow-success/30',
      ...
      >
        <div
          className={clsx(
            ...
            isSpinning && 'motion-safe:animate-flip',
            outcome === 'win' && 'border-success',
        ...
        {isSpinning ? (
          ...
          <span
            className={clsx(
              ...
              lastBet.outcome === 'win' ? 'text-success' : 'text-destructive',
            )}
          >
